...
import os
import sys
sys.path.insert(0, os.path.abspath('../curie/'))
...
# render single-backtick text (used throughout for class/method names) as
# inline code rather than the default italic title-reference
default_role = 'code'
...
# Let wide table cells wrap instead of forcing a horizontal scrollbar
# (the Read the Docs theme sets white-space: nowrap on table cells).
...
latex_documents = [
    (master_doc, 'Curie.tex', u'Curie Documentation',
     u'Jonathan Morrell', 'manual'),
]
...
man_pages = [
    (master_doc, 'curie', u'Curie Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Curie', u'Curie Documentation',
     author, 'Curie', 'Toolkit for gamma-ray spectroscopy, nuclear data and activation analysis.',
     'Miscellaneous'),
]
